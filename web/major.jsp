        ...
        <div >
            <div name="upload-data-info" class="upload-data-info" >
                ...
                <select id="datatype" name="datatype">
                    out.print("<option>矢量数据</option>");
                    out.print("<option>栅格数据</option>");
                </select>
            </div>
            <div name="upload-data-info" class="upload-data-info">
                <label >区域名称:</label>
                <input type='text' id='datatext2' name='locality' placeholder='例：XX省XX市XX县/区' >
            </div>
            <div name="upload-data-info" class="upload-data-info">
                <label >采集时间:</label>
                <input type="text" id="datatext3" name="time" placeholder="例：20010101" >
            </div>
            <div name="upload-data-info" class="upload-data-info">
                <label >西北点经纬:</label>
                <input type='text' id='datatext4' name='westnorth' placeholder='纬度73.3-135.34'>
            </div>
            <div name="upload-data-info" class="upload-data-info">
                <label >东南点经纬:</label>
                <input type='text' id='datatext5' name='eastsouth' placeholder='经度17.84-53.2'>
            </div>
        </div>

       <div name="upload-data-info" class="upload-data-info">
          <button type="submit" id="dataup" >
          保存
          </button>
       </div>
    </form>
